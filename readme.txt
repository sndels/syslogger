...
Usage
Just have syslogger running in one terminal and the client should register itself
before logging and unregister after. SIGPIPE needs to be ignored in the client for
the library error handling to work. Logging messages are printed using the suggested
format of
